...
UE2_IPV4_INTERNET_TUN_IP=$(python3 /mnt/smf/ip_utils.py --ip_range $UE2_IPV4_INTERNET)
UE2_IPV4_IMS_TUN_IP=$(python3 /mnt/smf/ip_utils.py --ip_range $UE2_IPV4_IMS)
...
sed -i 's|UE2_IPV4_INTERNET_TUN_IP|'$UE2_IPV4_INTERNET_TUN_IP'|g' install/etc/open5gs/smf.yaml
sed -i 's|UE2_IPV4_INTERNET_SUBNET|'$UE2_IPV4_INTERNET'|g' install/etc/open5gs/smf.yaml
sed -i 's|UE2_IPV4_IMS_TUN_IP|'$UE2_IPV4_IMS_TUN_IP'|g' install/etc/open5gs/smf.yaml
sed -i 's|UE2_IPV4_IMS_SUBNET|'$UE2_IPV4_IMS'|g' install/etc/open5gs/smf.yaml
